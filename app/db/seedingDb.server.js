...
async function insertData(User, Event, Comment) {
  const Dan = await User.create({
    ...
    age: 30,
    about:
      "I am a fitness enthusiast and love to stay active. I enjoy outdoor activities and meeting new people. I am looking forward to meeting new friends and participating in fun events.",
    gender: "Male",
  ...
  const Kasper = await User.create({
    ...
    age: 25,
    about:
      "I am a software developer and enjoy coding and building new applications. I am also a fitness enthusiast and enjoy outdoor activities. I am looking forward to meeting new friends and participating in fun events.",
    gender: "Female",
  ...
  const Sarah = await User.create({
    ...
    age: 30,
    about:
      "I am a gamer and enjoy playing video games. I am also a fitness enthusiast and enjoy outdoor activities. I am looking forward to meeting new friends and participating in fun events.",
    gender: "Male",
    password: "Password123",
    languages: ["English", "French"],
  });
  ...
  const John = await User.create({
    ...
    age: 40,
    about:
      "I am an actor and enjoy performing in theater. I am also a fitness enthusiast and enjoy outdoor activities. I am looking forward to meeting new friends and participating in fun events.",
    gender: "Male",
    password: "P@ssw0rd!",
    languages: ["English"],
  });
  ...
  const Emily = await User.create({
    image:
      "https://images.unsplash.com/photo-1664575603992-0f17b771dd91?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8d29tYW58ZW58MHx8MHx8fDA%3D",
    mail: "user6@example.com",
    firstname: "Emily",
    lastname: "Brown",
    age: 28,
    about:
      "I love to travel and explore new places. I am also a fitness enthusiast and enjoy outdoor activities. I am looking forward to meeting new friends and participating in fun events.",
    gender: "Female",
  ...
  const David = await User.create({
    ...
    age: 35,
    about:
      "My passion is music and I enjoy playing the guitar. I am also a fitness enthusiast and enjoy outdoor activities.",
    gender: "Male",
  ...
  const Sophia = await User.create({
    ...
    age: 31,
    about:
      "I am a fashion designer and enjoy creating new designs. I enjoy outdoor activities. I am looking forward to meeting new friends and participating in fun events.",
    gender: "Female",
  ...
  const James = await User.create({
    ...
    age: 40,
    about:
      "I am a chef and enjoy cooking new dishes. I enjoy outdoor activities. I am looking forward to meeting new friends and participating in fun events.",
    gender: "Male",
    password: "Secret123!",
  ...
  const Emma = await User.create({
    image:
      "https://plus.unsplash.com/premium_photo-1689266188052-704d33673e69?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8d29tYW58ZW58MHx8MHx8fDA%3D",
    mail: "user13@example.com",
    firstname: "Emma",
    lastname: "Martinez",
    age: 27,
    about:
      "I am a photographer and enjoy capturing moments. I enjoy outdoor activities. I am looking forward to meeting new friends and participating in fun events.",
    gender: "Female",
