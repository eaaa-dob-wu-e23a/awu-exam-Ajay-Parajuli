  ...
  return (
    <div className=" flex flex-col justify-center items-center w-full md:h-[90vh] xl:h-[90vh] relative">
      ...
      >
        ...
        <div className="flex flex-col mb-4">
          <label className="font-medium text-secondary text-sm" htmlFor="Date">
            {" "}
            <span className="block after:content-['*'] after:ml-0.5 font-medium text-secondary text-sm after:text-btntwo">
              Date
            </span>
        ...
        <div className="flex flex-col mb-4">
          <label className="font-medium text-secondary text-sm" htmlFor="Time">
            {" "}
            <span className="block after:content-['*'] after:ml-0.5 font-medium text-secondary text-sm after:text-btntwo">
              Time
            </span>
        ...
        <div className="flex justify-between mb-4 w-full">
          <div className="w-[90%]">
            ...
            <input
              className="border-2 bg-background text-secondary border-border p-1 rounded w-[90%]"
              id="city"
              type="text"
              name="city"
              aria-label="city"
        ...
        <div className="flex justify-between mt-2 w-full text-primary">
          <button className="bg-btnone p-2 rounded text-lg" type="submit">
            Create
          </button>
          <button
            className="bg-btntwo p-2 rounded text-lg"
...
export async function action({ request }) {
  ...
  const newEvent = {
    ...
    tags: tags
      .toLowerCase()
      .split(",")
      .map((tag) => tag.trim()), // Split tags string into an array of tags and make them lowercase
    timeTo,
    description,
