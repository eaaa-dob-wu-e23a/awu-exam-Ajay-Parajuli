...
console.log(actionData);
  ...
  return (
    <div className="flex flex-col justify-center items-center w-full xl:h-[100vh] ">
      ...
      <Form className="flex bg-background flex-col shadow-2xl p-4 rounded-xl w-[95%] sm:w-[85%] md:w-[70%] lg:w-[60%] xl:w-[40%] 2xl:w-[35%] border-2 border-border" id="sign-up-form" method="post">
        <h2 className="border-border text-secondary mb-4 pb-3 border-b-2 font-medium text-xl">Sign Up</h2>
        <div>
...
<div className="flex flex-col mb-4">
        ...
        <div className="mt-2 w-full text-primary">
          <button className="bg-btnone p-2 rounded w-full text-lg" type="submit">Sign Up</button>
        </div>
        <div className="mt-5 text-center">
      <p className="text-secondary">
        Already have an account? Sign in <NavLink className="text-btnone underline" to="/signin">here.</NavLink>
      </p>
      </div>
      </Form>
    </div>
